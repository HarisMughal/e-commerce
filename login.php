      ...
      <div class="container-fluid">
          ...
          <div class="row" style="background:url(Images/bg2.jpg); background-size:100% 100%; opacity: 0.9;">
              ...
              <div class="page-header  text-center">
                  <h1 style="font-size: 50px; font-weight: 400;"><b>Login Desk</b></h1>
              </div>
              <div class="row">
                  <?php echo Message();
                  echo SuccessMessage();
              ...
              <div class="col-md-4"  style="border:3px solid; border-radius: 30px; margin-bottom:20px" >
                ...
                <form action="" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-lg" name="username" id="username"  placeholder="e.g aliraza123"/>
                        </div>
                    ...
                    <button type="submit" name="submit" style="box-shadow: 2px 3px #21421e"class="btn btn-success btn-block ">Submit</button>
                    <br><br>
